    ...
    <div className='flex flex-col justify-center items-center'>
      <div className='w-[60%]'>
        <form className="flex flex-col rounded-2xl mt-5 lg:mt-20 p-4 lg:h-[280px] px-60">
          <div>
            <h1 className="text-3xl text-purple-800 text-center mb-4 lg:mb-8">
              Criar conta
            </h1>

            <label className="flex flex-col ml-4 text-xl mb-1">
              Nome
            </label>
            <input 
              type='text' 
            ...
            <label className="flex flex-col ml-4 text-xl mb-1 mt-3">
              e-mail
            </label>
            <input
              type="email"
          ...
          <div className='flex justify-center'>
            <button 
              type='submit' 
              className='bg-purple-600 rounded-lg p-2 w-[50%] text-white'>
                Cadastrar
            </button>

...
import SendToLogin from "../../../utils/sendToLogin";
...
export const FavoriteFile = () => {
    ...
    if (session) {
        ...
        return (
            <div className="flex flex-col justify-center items-center lg:py-10 lg:ml-[23rem] mt-64 lg:mt-10 lg:p-4 lg:w-[69%] h-[533px] p-5">
                <h1

  ...
  render() {
    ...
    return (
      <div className="mx-auto xl:w-8/12 md:w-4/6">
        <div className="">
        <h2 className="md:flex lg:flex text-start mb-8 text-2xl font-bold text-red-600">Promoções de natal</h2>
        <Slider {...settings}>
          <div className="border border-gray-200 lg:p-4">
            <img src="https://th.bing.com/th/id/OIP.widuAEj4UbYw0y3Vp3f92wHaHa?w=201&h=201&c=7&r=0&o=5&pid=1.7" className="object-contain mx-auto h-72" alt=""/>
          </div>
          <div className="border border-gray-200 lg:p-4">
            <img src="https://th.bing.com/th/id/OIP.widuAEj4UbYw0y3Vp3f92wHaHa?w=201&h=201&c=7&r=0&o=5&pid=1.7" className="object-contain mx-auto h-72" alt=""/>
          </div>

        ...
        <div className='w-[70%] mx-auto border h-[600px] p-8'>
            <div className='grid grid-cols-[200px_minmax(100px,_1fr)] gap-10'>
                <div className='ml-4'>
                    ...
                    <div className='absolute w-48 h-48 p-5 shadow-md shadow-gray-400 rounded-lg'>
                        <div className="flex flex-col justify-center items-center gap-3">
                            <div className='text-xl text-gray-600'>Notas</div>
                ...
                <div className='border col-span-1 shadow-sm shadow-gray-500 rounded-xl p-4'>
                    <div className='mt-5'>
                        <h1 className='flex justify-center text-3xl text-gray-600 mb-5'>Avaliações</h1>
                    </div>
                    <hr className='py-5' />
                        ...
                        {itemRatings[item?.id as number]?.map(item => (
                            <li className="flex flex-col gap-2">
                                ...
                                <div className="flex gap-3">
                                    <Rating value={item.rating} className="" size={"medium"} />
                                    <span className="text-xl text-gray-800 font-medium ">{item.title}</span>
                                </div>
                                <div className="max-w-lg">{item.label}</div>
                            </li>
                        ))}
                    </ul>
                </div>
